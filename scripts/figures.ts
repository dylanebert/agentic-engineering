...
// Twelve arms total, by name: page-varies, page-reduced-motion, page-contrast-sweep,
...
// missing-asset-404. Display-gated like shot.ts; WSL branch stages onto Windows TEMP and runs
// through PowerShell.

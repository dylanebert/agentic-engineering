...
console.log(JSON.stringify({ findings, limits: 'Lexical length/relative-word tripwires do not certify concision, educational clarity or taste. Both standalone readings were rejected; future article judgment is separate.' }, null, 2));

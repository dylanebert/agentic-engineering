...
Dylan has confirmed the note works through a coordinator-operated tunnel to Omarchy. Both standalone readings were rejected, and that review mechanism is retired. The [human record](human/feedback.json) separates functional confirmation from those rejections. The next human look belongs in the separately scoped article, not another report or repeated functional test.

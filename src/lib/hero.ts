...
const scene = `<scene>
  ...
  <a id="camera" camera="clear-color: 0xfbfcfd" sear glaze="tonemap: 1" transform orbit="distance: 4; yaw: 0.6; pitch: 0.3; target: @cube" />
  <a id="cube" part transform="scale: 1.4" color="rgba: 0.85 0.55 0.35" />
</scene>`;

...
<style>
.hero{width:100%;margin:40px 0 58px}.spectrum{width:100%;display:block;overflow:visible}.spectrum path,.spectrum rect,.spectrum circle{fill:none;stroke:currentColor;stroke-width:2;vector-effect:non-scaling-stroke}.spectrum rect[data-role="prose"]{color:var(--role-prose)}.spectrum rect[data-role="agentic"]{color:var(--role-agentic)}.spectrum rect[data-role="vibe"]{color:var(--role-vibe)}.spectrum .dot{fill:currentColor;stroke:none;transform:translateX(calc(274px + 192px * sin(360deg * var(--phase))))}.canvas-wrap{position:relative;width:100%;height:220px}canvas,pre{position:absolute;inset:0;width:100%;height:100%}canvas{display:block;opacity:0}canvas.drawn{opacity:1}pre{margin:0;display:grid;place-content:center;font-family:var(--mono);font-size:12px;line-height:1em;white-space:pre;color:var(--role-agentic)}pre.drawn{visibility:hidden}@media(max-width:560px){.hero{margin:28px 0 42px}}
</style>
